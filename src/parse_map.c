...
/*   Updated: 2024/05/13 16:58:59 by ndo-vale         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	alloc_map(t_root *root)
{
	...
	root->map.matrix = (char **)ft_calloc(root->map.height + 1, sizeof(char *));
	if (!root->map.matrix)
	{
	...
	{
		root->map.matrix[y] = (char *)ft_calloc(
				root->map.width + 1, sizeof(char));
